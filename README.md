...
the build and validation design. The repository itself has no selected license;
the workflow separately collects applicable ANGLE and third-party notices in
its build artifact.
